...
public partial class ClientDashboard : UserControl
{
        ...
        ComboBox directionCombo)
    {
        ...
        foreach (var s in services)
        {
            ...
            var card = new Border
            {
                Background = new SolidColorBrush(UiColors.BgCard),
    ...
    private static Control BuildImage(string? path)
    {
        ...
        if (bmp == null)
        {
            return new Border
            {
                Width = 140,
                Height = 100,
                Background = new SolidColorBrush(UiColors.BgCardMuted),
                Child = new TextBlock
                {
                    Text = "Нет фото",
                    HorizontalAlignment = HorizontalAlignment.Center,
                    VerticalAlignment = VerticalAlignment.Center,
                    Foreground = new SolidColorBrush(UiColors.TextPrimary)
                }
            };
        }
        ...
        return new StackPanel
        {
            ...
            Children =
            {
                ...
                new TextBlock
                {
                    ...
                    Foreground = new SolidColorBrush(UiColors.TextSecondary)
                },
                new TextBlock
                {
                    Text = s.Description,
                ...
                new TextBlock { Text = $"{s.Price:N0} ₽", Foreground = new SolidColorBrush(UiColors.AccentPrice) },
                book
            }
        };
    }
                ...
                Child = new StackPanel
                {
                    ...
                    Children =
                    {
                        ...
                        new TextBlock
                        {
                            ...
                            Foreground = new SolidColorBrush(UiColors.TextMuted),
                            FontSize = 12
                        }
                    }
                }
